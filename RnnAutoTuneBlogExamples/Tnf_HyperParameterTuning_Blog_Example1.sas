/* 
   ...
   Target variable: air
   Total number of models: 243

*/


data mycas.in_hyperpara_set;
input ninput nlayer nneuron learningRate algorithm $10.;
cards;
6  3 20  0.1    ADAM     
12 4 30  0.01   VANILLA  
18 5 40  0.001  MOMENTUM 
;
;
run;
...
by _id_;
var &target;
inscalar ninput nlayer nneuron learningRate algorithm;
require tnf;
submit;
